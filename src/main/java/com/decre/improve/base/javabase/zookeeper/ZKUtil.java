...
public class ZKUtil {
     ...
     */
    public static Map<String, String> getChildNodeAndValue(String path, ZooKeeper zk, Map<String, String> map) throws KeeperException, InterruptedException {
        //看看传入的节点是否存在
     ...
     * @throws InterruptedException
     */
    public static boolean rmr(String path, ZooKeeper zk) throws KeeperException, InterruptedException {
        //看看传入的节点是否存在
        if (zk.exists(path, false) != null) {
            //查看该节点下是否还有子节点
     ...
     * @throws InterruptedException
     */
    public static boolean createZNode(String znodePath, String data, ZooKeeper zk) throws KeeperException, InterruptedException {
        //看看要创建的节点是否存在
     ...
     * @throws InterruptedException
     */
    public static boolean clearChildNode(String znodePath, ZooKeeper zk) throws KeeperException, InterruptedException {
