package com.decre.improve.base.javabase.zookeeper.curator;
...
public class CuratorConnectTest {
    ...
    private static CuratorFramework client = CuratorFrameworkFactory.builder().connectString("hadoop1:2181,hadoop2:2181,hadoop3:2181,hadoop4:2181").sessionTimeoutMs(3000).connectionTimeoutMs(5000).retryPolicy(retryPolicy).build();
